...
const daffy = require("../assets/images/daffy.jpeg");
const banku = require("../assets/images/banku.jpg");
const fufu = require("../assets/images/fufu.jpeg");
const agatha = require("../assets/images/agatha.jpg");
const kokonte = require("../assets/images/kokonte.jpg");
const palace = require("../assets/images/palace.jpeg");
const casa = require("../assets/images/casa.jpg");
const jollof = require("../assets/images/jollof.jpg");
const friedrice = require("../assets/images/friedrice.jpeg");
const assortedfried = require("../assets/images/assortedfried.jpg");
const assortedjollof = require("../assets/images/assortedjollof.jpg");
const porkinpacl = require("../assets/images/porkinpacl.jpeg");
const porkinpark = require("../assets/images/porkinpark.jpg");
const akos = require("../assets/images/akos.jpg");
